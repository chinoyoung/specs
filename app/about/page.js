    ...
    <Protected>
      ...
      <div className="dashboard-card p-6 mb-8">
        ...
        <div className="prose max-w-none text-dark-700">
          ...
          <h2 className="flex items-center gap-2 text-primary-600">
            <svg
          ...
          <ul className="space-y-2">
            <li className="flex items-start">
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="text-primary-500 mt-1 mr-2"
              >
            ...
            <li className="flex items-start">
              ...
              Custom viewport sizing to test responsive designs
            </li>
            <li className="flex items-start">
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <li className="flex items-start">
              ...
              Batch processing for capturing multiple elements
            </li>
            <li className="flex items-start">
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <li className="flex items-start">
              ...
              Configure different URLs for each ad category
            </li>
          </ul>

          <h2 className="flex items-center gap-2 text-primary-600 mt-6">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
